    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 p-4 bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl">
                  ...
                  <div className="flex-1">
                    ...
                    <a href="mailto:ntecchess@school.edu.vn" className="text-cyan-600 hover:text-cyan-700">
                ...
                <div className="flex items-start gap-4 p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl">
                  ...
                  <div className="flex-1">
                    ...
                    <a href="tel:+84123456789" className="text-cyan-600 hover:text-cyan-700">
                      (+84) 123 456 789
                    </a>
                  </div>
                </div>
            ...
            <div>
              <h2 className="text-3xl font-bold text-slate-900 mb-8">Kết nối với chúng tôi</h2>
              
              <div className="space-y-6 mb-8">
                <a href="#" className="flex items-center gap-4 p-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors">
                ...
                <a href="#" className="flex items-center gap-4 p-4 bg-sky-500 text-white rounded-xl hover:bg-sky-600 transition-colors">
                  <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#" className="flex items-center gap-4 p-4 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-colors">
                  <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#" className="flex items-center gap-4 p-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-xl hover:from-purple-600 hover:to-pink-600 transition-colors">
                  <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-gradient-to-br from-slate-50 to-cyan-50 p-6 rounded-xl">
                <h3 className="text-xl font-bold text-slate-900 mb-4">📝 Gửi tin nhắn nhanh</h3>
                <p className="text-gray-600 mb-4">
                  Bạn có thắc mắc? Hãy liên hệ trực tiếp với chúng tôi qua các kênh trên 
                  hoặc đến trực tiếp phòng CLB tại trường.
                </p>
                <a 
                  href="/join" 
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="aspect-video bg-gradient-to-br from-cyan-100 to-blue-200 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-2xl font-bold text-slate-900 mb-2">Trường THPT XYZ</p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">Câu hỏi thường gặp</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-cyan-500 to-blue-600 mx-auto"></div>
          </div>
            ...
            {[
              {
                ...
                answer: 'Bạn có thể đăng ký tham gia thông qua form trên website hoặc liên hệ trực tiếp với ban quản lý CLB.'
              },
              {
                question: 'CLB có phù hợp với người mới bắt đầu không?',
                answer: 'Có! CLB chào đón tất cả các bạn, từ người mới bắt đầu đến người có kinh nghiệm. Chúng tôi có các buổi học dành riêng cho người mới.'
              },
              {
                question: 'Lệ phí tham gia là bao nhiêu?',
                answer: 'CLB hoàn toàn miễn phí cho học sinh trong trường. Một số giải đấu có thể có phí đăng ký nhỏ để trang trải chi phí.'
              },
              {
                question: 'Tôi cần chuẩn bị gì khi tham gia?',
                answer: 'Chỉ cần sự đam mê với cờ vua! CLB có đầy đủ bàn cờ và đồng hồ cho thành viên.'
              },
            ].map((faq, index) => (
              <div key={index} className="bg-gradient-to-br from-slate-50 to-blue-50 p-6 rounded-xl shadow hover:shadow-lg transition-shadow">
